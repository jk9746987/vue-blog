        ...
        <div class="container">
            ...
            <div class="blog-info">
                ...
                <div class="upload-file">
                    <label for="blog-photo">上傳封面圖片</label>
                    <input type="file" ref="blogPhoto" id="blog-photo" @change="fileChange" accept=".png, .jpg, .jpeg">
                    <button @click="openPreview" class="preview" :class="{'button-inactive': !this.$store.state.blogPhotoFileURL}">預覽圖片</button>
                    <span>選擇圖片: {{this.$store.state.blogPhotoName}}</span>
                </div>
            </div>
            <div class="editor">
            ...
            <div class="blog-actions">
                <button @click="updateBlog">確認編輯</button>
                <router-link class="router-button" :to="{ name: 'BlogPreview' }">預覽文章</router-link>
            </div>
        </div>
    </div>
</template>
